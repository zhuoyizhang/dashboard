...
OMENBooted <- google_analytics(ga_JumpStart_id, 
                                    c(startDate,endDate), 
...
AllLaunches  <- google_analytics(ga_id, 
                                        c(startDate,endDate), 
                                        dimensions=c(month_or_week), 
                                        segments = seg_obj, 
                                        metrics = c('users')
...
AvgDurationandSessions <- google_analytics(ga_id, 
                                          c(startDate,endDate), 
                                          dimensions=c(month_or_week), 
                                          segments = seg_obj, 
...
fc_exact_ret <- filter_clause_ga4(list(df_exact_ut_ret))
eligibleNetworkUsers <- google_analytics(ga_id, 
                                          c(startDate,endDate), 
                                          dimensions=c(month_or_week), 
                                          segments = seg_obj, 
                                          metrics = c("users"),
...
networkreturn <- google_analytics(ga_id, 
                                          c(startDate,endDate), 
                                          dimensions=c(month_or_week), 
                                          segments = seg_obj, 
                                          metrics = c("users"),
...
fc_exact_ret <- filter_clause_ga4(list(df_exact_ut_ret,df_exact_ut_ret2),operator="AND")
NetworkSwitched <- google_analytics(ga_id, 
                                          c(startDate,endDate), 
                                          dimensions=c(month_or_week), 
                                          segments = seg_obj, 
...
fc_exact_ret <- filter_clause_ga4(list(df_exact_ut_ret))
eligibleUsers <- google_analytics(ga_id, 
                                          c(startDate,endDate), 
                                          dimensions=c(month_or_week), 
                                          segments = seg_obj, 
                                          metrics = c("users"),
...
df_exact_ut_ret2 <- dim_filter("userType","REGEXP","returning",caseSensitive = FALSE,not = FALSE)
fc_exact_ret <- filter_clause_ga4(list(df_exact_ut_ret,df_exact_ut_ret2),operator="AND")
macroreturn <- google_analytics(ga_id, 
                                          c(startDate,endDate), 
                                          dimensions=c(month_or_week), 
                                          segments = seg_obj, 
                                          metrics = c("users"),
...
fc_exact_ret <- filter_clause_ga4(list(df_exact_ut_ret,df_exact_ut_ret2,df_exact_ut_ret3),operator="AND")
MacroKeys <- google_analytics(ga_id, 
                                          c(startDate,endDate), 
                                          dimensions=c(month_or_week), 
                                          segments = seg_obj, 
                                          metrics = c("users","totalEvents"),
...
df_exact_ut_ret2 <- dim_filter("userType","REGEXP","returning",caseSensitive = FALSE,not = FALSE)
fc_exact_ret <- filter_clause_ga4(list(df_exact_ut_ret,df_exact_ut_ret2),operator="AND")
lightingreturn <- google_analytics(ga_id, 
                                          c(startDate,endDate), 
                                          dimensions=c(month_or_week), 
                                          segments = seg_obj, 
                                          metrics = c("users"),
...
fc_exact_ret <- filter_clause_ga4(list(df_exact_ut_ret,df_exact_ut_ret2,df_exact_ut_ret3),operator="AND")
OCIntelApplied <- google_analytics(ga_id, 
                                          c(startDate,endDate), 
                                          dimensions=c(month_or_week), 
                                          segments = seg_obj, 
                                          metrics = c("users","totalEvents"),
...
df_exact_ut_ret2 <- dim_filter("userType","REGEXP","returning",caseSensitive = FALSE,not = FALSE)
fc_exact_ret <- filter_clause_ga4(list(df_exact_ut_ret,df_exact_ut_ret2),operator="AND")
ocreturn <- google_analytics(ga_id, 
                                          c(startDate,endDate), 
                                          dimensions=c(month_or_week), 
                                          segments = seg_obj, 
                                          metrics = c("users"),
